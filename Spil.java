            ...
            if (!skiftSpiller) {
                ...
                switch (sum) {
                    case 2:
                        ...
                        spiller1.indsætPenge(250);
                        break;
                    case 3:
                        feltTekst = "Crater: Du får en sten i hoved og mister 100";
                        spiller1.hævPenge(100);
                        break;
                    case 4:
                        feltTekst = "Palace Gates: Du er belønnet 100 for at træde gennem porten";
                        spiller1.indsætPenge(100);
                        break;
                    case 5:
                        feltTekst = "Cold Desert: Du sidder fast i ørkenen og mister 20";
                        spiller1.hævPenge(20);
                        break;
                    case 6:
                        feltTekst = "Walled City: Du finder en skjult by og er belønnet 180";
                        spiller1.indsætPenge(180);
                        break;
                    case 7:
                        feltTekst = "Monastery: Du tar en kort te pause pause";
                        break;
                    case 8:
                        feltTekst = "Black Cave: Du sidder fast i en grotte og mister 70";
                        spiller1.hævPenge(70);
                        break;
                    case 9:
                        feltTekst = "Huts in the Mountain: Du er belønnet 60 for at finde bjergfolket";
                        spiller1.indsætPenge(60);
                        break;
                    case 10:
                        feltTekst = "The Werewall (werewolf-wall): Du møder en vareulv og giver den 80, men du får lov til at slå igen";
                        spiller1.hævPenge(80);
                        ekstraTur = true;
                        break;
                    case 11:
                        feltTekst = "The Pit: Du falder ned i et hul og mister 50";
                        spiller1.hævPenge(50);
                        break;
                    case 12:
                        feltTekst = "Goldmine: Du finder en guldmine, du er rig";
                        spiller1.indsætPenge(650);
                        break;
                }
